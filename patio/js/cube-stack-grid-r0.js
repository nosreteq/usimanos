...
var CubeStackGrid = (function () {
  ...
  api.create = function (opt) {
    ...
    ud.forEachTile =
      opt.forEachTile === undefined ? DEFAULT_FOR_EACH_TILE : opt.forEachTile;
    ud.stackOptionPalette =
      opt.stackOptionPalette === undefined
        ? DEFAULT_STACK_OPTION_PALETTE
        : opt.stackOptionPalette;
    ud.sopArray =
      opt.sopArray === undefined ? DEFAULT_SOP_INDICES : opt.sopArray;
    ...
    sopArray.forEach(function (sopIndex, i) {
      ...
      var stack = CubeStack.create({
        ...
        colors: stackOpt.colors || [[0, 1, 1, [255, 255]]],
      ...
      var sx =
        (((ud.stackGW + ud.space) * ud.gw - ud.stackGW - ud.space) / 2) * -1;
      var sy =
        (((ud.stackGH + ud.space) * ud.gh - ud.stackGH - ud.space) / 2) * -1;
      stack.position.set(
